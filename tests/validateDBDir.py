...
if __name__ == "__main__":
	if sys.argv[1] == "-h" or sys.argv[1] == "--help":
		print( "validateDB.py path-to-db-directory definitions.dbd")
		quit()
	
	if not (2 <= len(sys.argv) <= 4):
		print( "Usage: validateDB.py path-to-db-directory definitions.dbd")
		quit()
